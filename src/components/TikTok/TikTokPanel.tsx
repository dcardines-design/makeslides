    ...
    <div className="space-y-3">
      {!isConnected ? (
        <button
          ...
          disabled={connecting}
          className="w-full px-[14px] py-3 rounded-[10px] bg-[#1F1F1F] border border-[#2B2B2B] text-white font-medium text-[12px] tracking-[1px] transition-colors hover:bg-[#2a2a2a] hover:border-[#3B1CD1] flex items-center justify-center gap-2 disabled:opacity-50"
